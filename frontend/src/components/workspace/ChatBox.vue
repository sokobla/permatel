<template>
  <div class="cbx-root">
    <!-- ══ SIDEBAR ══════════════════════════════════════════════════════════ -->
    <aside
      :class="['cbx-sidebar', { 'cbx-sidebar--full': !activeConversation }]"
    >
      ...
      <div class="cbx-search">
        <input
          ...
          autocomplete="off"
        />
        <v-icon size="14" color="#bbb" class="cbx-search__icon"
          >mdi-magnify</v-icon
        >
      </div>
        ...
        >
          <div class="cbx-dm-avatar-wrap">
            ...
            <span
              class="cbx-dm-dot"
              :class="
                dm.status === 'online' ? 'cbx-dm-dot--on' : 'cbx-dm-dot--off'
              "
            ></span>
          </div>
    ...
    <template v-if="activeConversation">
      ...
      <main class="cbx-conv">
        ...
        <header class="cbx-conv-hdr">
          <div class="cbx-conv-hdr__left">
            <span
              ...
              class="cbx-conv-hdr__hash"
              >#</span
            >
            <span class="cbx-conv-hdr__name">{{
        ...
        <div class="cbx-input-area">
          <div class="cbx-toolbar">
            ...
            <button class="cbx-tool cbx-tool--i" title="Italique">
              <i>I</i>
            </button>
            <button class="cbx-tool cbx-tool--u" title="Souligné">
              <u>U</u>
            </button>
      ...
      <transition name="cbx-profile-slide">
        <aside
          v-if="showProfile && activeConversation?.type !== 'channel'"
          class="cbx-profile"
        >
...
.cbx-sidebar::-webkit-scrollbar {
  width: 3px;
}
.cbx-sidebar::-webkit-scrollbar-thumb {
...
.cbx-search__input:focus {
  border-color: rgba(0, 168, 168, 0.4);
}
.cbx-search__input::placeholder {
  color: #c0c0c0;
}
...
.cbx-profile::-webkit-scrollbar {
  width: 3px;
}
.cbx-profile::-webkit-scrollbar-thumb {
  background: rgba(0, 0, 0, 0.1);
  border-radius: 2px;
}
